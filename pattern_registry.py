...
pattern_templates = {
    ...
    "fallback_safe_design": "Provide a conservative, well-tested design approach with clear rationale.",
    "fallback_user_centric": "Focus on user needs and pain points, then propose solutions.",
    "fallback_systematic": "Break this down into systematic steps with clear criteria and evaluation metrics."
}
