...
def main():
    ...
    if args.command == "run":
        ...
        # Register intelligence & orchestration agents
        ...
        print(f"✅ Registered 22 working agents across all categories")
        print(f"✅ Registered tools: ux_audit, trust_explainer")
        print(f"✅ Intelligence & orchestration agents: prompt_master, dispatcher")
